...
table(df$repeat_thy_classification)
## @ns-rse 2024-06-18:
...
```{r}
## changing NA in thy_class to "no biopsy"

df <- df |>
  mutate(thy_classification = ifelse(is.na(thy_classification), "No biopsy", thy_classification))
view(df$thy_classification)
```
