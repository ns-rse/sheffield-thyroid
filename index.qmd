...
@patient_demo shows the demographics of patients included in this study. A total of `r n_obs` patients were included in
this study with a median (IQR) age of  `r gtsummary::inline_text(patient_demo, variable="age_at_scan")`.

```{r}
#| label: clinical_charac
#| eval: true
#| echo: false
#| warning: false
#| tbl-caption: ""
...
@clinical_charac shows the destribution of clinical variables evaluated between benign and malignant thyroid nodules.
